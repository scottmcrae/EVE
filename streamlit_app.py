...
[data-testid="stTabs"] [data-baseweb="tab"]:nth-child(2)[aria-selected="true"] {
    color: #ff8c00 !important; background: rgba(255,140,0,0.08) !important;
    border-color: #cc6600 !important; border-bottom: 2px solid #ff8c00 !important;
}
[data-testid="stTabs"] [data-baseweb="tab"]:nth-child(3)[aria-selected="true"] {
    color: #ffffff !important; background: rgba(255,255,255,0.05) !important;
    border-color: #aaaaaa !important; border-bottom: 2px solid #ffffff !important;
}
...
<table class="mkt-table" id="{tid}">
    ...
    <tr>
        ...
        <th style="cursor:pointer" onclick="sortTable('{tid}','asv',this)">ASV <span class="sort-ind"></span></th>
        <th style="cursor:pointer" onclick="sortTable('{tid}','abv',this)">ABV <span class="sort-ind"></span></th>
        <th style="cursor:pointer" onclick="sortTable('{tid}','sold',this)">Sold today <span class="sort-ind"></span></th>
        <th style="cursor:pointer" onclick="sortTable('{tid}','isk',this)">PROFIT <span class="sort-ind">▼</span></th>
    </tr>
    </thead>
    <tbody>{rows}</tbody>
</table>
